[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=15573120&assignment_repo_type=AssignmentRepo)
# SE_Day1
...
Importance: Prompt engineering helps avoid confused answers by making your questions clear and specific, so the AI understands exactly what you need. 
It helps improve the interaction between humans and AI. Prompt engineering reduces stress, makes work faster and effective for users.

Provide an example of a vague prompt and then improve it by making it clear, specific, and concise. Explain why the improved prompt is more effective.
Ans: Vague- Tell me about Nigeria's culture
Improved prompt- Simply explain the cultures of the three political zones in Nigeria which are the Igbos, Yorubas and Hausas
The improved prompt was able to make the AI understand the specific zones i needed details on because Nigeria is a nation and therefore have so many cultures.
